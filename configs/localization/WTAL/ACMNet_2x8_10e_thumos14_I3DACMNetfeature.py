...
data_root = 'data/THUMOS-14/train'
data_root_val = 'data/THUMOS-14/test'
ann_file_train = 'data/THUMOS-14/train.json'
ann_file_val = 'data/THUMOS-14/test.json'
ann_file_test = 'data/THUMOS-14/test.json'
action_classes_path = 'data/THUMOS-14/action_classes.json'
...
test_pipeline = [
    dict(type='LoadLocalizationI3DFeature', dataset = 'thumos14_ACMNat', temporal_dim = temporal_dim),
...
data = dict(
    ...
    train=dict(
        ...
        test_cfg=test_cfg_))
evaluation = dict(interval=1, metrics=['mAP'])
...
work_dir = './work_dirs/ACMNet_2x8_10e_thumos14_I3DACMNetfeature/'
