'''
Author: Thyssen Wen
Date: 2021-09-22 19:36:50
LastEditors: Thyssen Wen
LastEditTime: 2021-09-23 14:32:43
Description: file content
FilePath: /mmaction2/mmaction/models/losses/cola_loss.py
'''
...
class CoLALoss(nn.Module):
    def __init__(self):
        super(CoLALoss, self).__init__()
